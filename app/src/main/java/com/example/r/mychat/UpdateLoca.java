 ...
 */
public class UpdateLoca extends AppCompatActivity {

    private static final String TAG = UpdateLoca.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.updateloca);
        ...
        mAddressOutput = "cccc";
        Toast.makeText(UpdateLoca.this,mAddressOutput,Toast.LENGTH_LONG);
    ...
    private void startIntentService() {
        ...
        Intent intent = new Intent(UpdateLoca.this, FetchAddressIntentService.class);
            ...
            showSnackbar(R.string.permission_rationale, android.R.string.ok,
                    new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Request permission
                            ActivityCompat.requestPermissions(UpdateLoca.this,
